...
if IN_RASPBERRY:
    ...
    sleep_interval = 0.1
    #  backward    //     forward           
    # dd di td ti  //  dd di td ti
    STOP =             0b11111111 # 255
    FORWARD =          0b00001111 #  15
    BACKWARD =         0b11110000 # 240
    CLOCKWISE =        0b10100101 # 165 
    COUNTERCLOCKWISE = 0b01011010 #  90 
    RIGHT =            0b01101001 # 105
    LEFT =             0b10010110 # 150
    FORWARD_RIGHT =    0b00001001 # 9
    FORWARD_LEFT =     0b00000110 # 6
    BACKWARD_RIGHT =   0b01100000 # 96
    BACKWARD_LEFT =    0b10010000 # 144
